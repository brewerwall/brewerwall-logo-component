...
const bebasNeueSemiRoundedRegular = {
  ...
  fontWeight: "bold",
  src:
    "url('./fonts/BebasNeueSemiRounded-Regular.eot?#iefix') format('embedded-opentype'), url('./fonts/BebasNeueSemiRounded-Regular.woff') format('woff'), url('./fonts/BebasNeueSemiRounded-Regular.ttf') format('truetype'), url('./fonts/BebasNeueSemiRounded-Regular.svg#BebasNeueSemiRounded-Regular') format('svg')",
...
class Logo extends React.Component {
    ...
    switch (this.props.size) {
      case "extra-small":
        return css(
          ...
          styles.logoTitleExtraSmall,
          this.getColorStyle()
        );
      case "small":
        return css(
          styles.logoTitleBase,
          styles.logoTitleSmall,
          this.getColorStyle()
        );
      case "medium":
        return css(
          styles.logoTitleBase,
          styles.logoTitleMedium,
          this.getColorStyle()
        );
      case "large":
        return css(
  ...
  getLogoTitle() {
    if (this.props.showTitle) {
      return <span className={this.getLogoTitleStyle()}>{title}</span>;
    }
  }
  ...
  getLogoSVG() {
    switch (this.props.type) {
      ...
      case "light_transparent":
        return (
          <LightTransparent alt="logo" className={this.getLogoImageStyle()} />
        );
      case "light_solid":
      ...
      case "dark_transparent":
        return (
          <DarkTransparent alt="logo" className={this.getLogoImageStyle()} />
        );
      case "dark_solid":
      ...
      default:
        return (
          <DarkColor
            alt="logo"
            className={this.getLogoImageStyle()}
            width={150}
          />
        );
    }
